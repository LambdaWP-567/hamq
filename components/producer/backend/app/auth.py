"""
JWT authentication module for the HAMq Producer API.
...
async def login_for_access_token(request: LoginRequest) -> TokenResponse:
    ...
    """
    # Validate username first (constant-time comparison via verify_password
    # handles the password — comparing usernames in plain Python is fine
    # because the username is not secret).
